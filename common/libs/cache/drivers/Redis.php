...
namespace libs\cache\drivers;

use libs\cache\interfaces\driver\Base;
use libs\cache\interfaces\driver\Lock;
use libs\cache\interfaces\driver\Incr;
use libs\cache\interfaces\driver\Multi;
use \RedisException;
...
class Redis implements Base, Lock, Incr, Multi {
    ...
    use \libs\cache\traits\CacheDriver;
